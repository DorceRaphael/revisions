...
document
  .querySelector("#two-btn")
  .addEventListener("click", function (twoInput) {
    twoInput = document.querySelector("#two-input").value;
...
const number = "^[0-9.,]*$";
threeResult = document.querySelector(".three");
document
  .querySelector("#three-btn")
  .addEventListener("click", function (threeInput) {
    threeInput = document.querySelector("#three-input").value;
...
document
  ...
  .addEventListener("click", function (fourInput) {
    fourInput = document.querySelector("#four-input").value;
